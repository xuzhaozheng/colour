...
CCS_LIGHT_SOURCES_RIT_STANDARD_OBSERVER_2_DEGREE_CIE1931: CanonicalMapping = (
    CanonicalMapping(
        {
            "Natural": np.array([0.381585730647787, 0.359224138274067]),
            "Philips TL-84": np.array([0.378413599970988, 0.379290254544090]),
            "SA": np.array([0.447573030734154, 0.407438137156467]),
            "SC": np.array([0.310056734303928, 0.316145704789204]),
            "T8 Luxline Plus White": np.array([0.410492204086250, 0.388932529676840]),
            "T8 Polylux 3000": np.array([0.431706082207185, 0.413877736072647]),
            "T8 Polylux 4000": np.array([0.379219473139794, 0.384469085577631]),
            "Thorn Kolor-rite": np.array([0.381919124282806, 0.374309261641251]),
        }
    )
)
"""
...
CCS_LIGHT_SOURCES_RIT_STANDARD_OBSERVER_10_DEGREE_CIE1964: CanonicalMapping = (
    CanonicalMapping(
        {
            "Natural": np.array([0.384870991183035, 0.353869223366545]),
            "Philips TL-84": np.array([0.383592002892950, 0.373922741815762]),
            "SA": np.array([0.451176803594070, 0.405936046781591]),
            "SC": np.array([0.310388637415649, 0.319050651220986]),
            "T8 Luxline Plus White": np.array([0.416946978831203, 0.380991426462756]),
            "T8 Polylux 3000": np.array([0.439038926288670, 0.404554330124715]),
            "T8 Polylux 4000": np.array([0.385115161872875, 0.377800928395769]),
            "Thorn Kolor-rite": np.array([0.385533929282467, 0.370840492090948]),
        }
    )
)
"""
...
CCS_LIGHT_SOURCES_NIST_TRADITIONAL_STANDARD_OBSERVER_2_DEGREE_CIE1931: CanonicalMapping = CanonicalMapping(  # noqa: E501
    {
        "Cool White FL": np.array([0.369256318971281, 0.372549878176631]),
        "Daylight FL": np.array([0.312662993963651, 0.331985688793009]),
        "HPS": np.array([0.521677696062816, 0.417971177117239]),
        "Incandescent": np.array([0.450730217519680, 0.408046128945005]),
        "LPS": np.array([0.575151311365165, 0.424232234924905]),
        "Mercury": np.array([0.392018457637112, 0.383777071984453]),
        "Metal Halide": np.array([0.372544558972793, 0.385603925927588]),
        "Neodimium Incandescent": np.array([0.447398697052100, 0.395008601248268]),
        "Super HPS": np.array([0.470061659271846, 0.406116584248741]),
        "Triphosphor FL": np.array([0.413163268257275, 0.396422053758680]),
    }
)
"""
Chromaticity coordinates of the traditional light sources from the *NIST*
...
CCS_LIGHT_SOURCES_NIST_TRADITIONAL_STANDARD_OBSERVER_10_DEGREE_CIE1964: CanonicalMapping = CanonicalMapping(  # noqa: E501
    {
        "Cool White FL": np.array([0.376715047518455, 0.364576802118673]),
        "Daylight FL": np.array([0.317395878738965, 0.330780819136676]),
        "HPS": np.array([0.531764495177513, 0.408752715284645]),
        "Incandescent": np.array([0.454365604973572, 0.406573684216774]),
        "LPS": np.array([0.589960045887891, 0.410039954112109]),
        "Mercury": np.array([0.401266412873755, 0.364732538221183]),
        "Metal Halide": np.array([0.378786167751226, 0.377496928504661]),
        "Neodimium Incandescent": np.array([0.447516717156694, 0.396734151368497]),
        "Super HPS": np.array([0.473859567146135, 0.401381825309197]),
        "Triphosphor FL": np.array([0.418591963931736, 0.388947713332192]),
    }
)
"""
Chromaticity coordinates of the traditional light sources from the *NIST*
...
"""
CCS_LIGHT_SOURCES["cie_2_1931"] = CCS_LIGHT_SOURCES[
    "CIE 1931 2 Degree Standard Observer"
]
CCS_LIGHT_SOURCES["cie_10_1964"] = CCS_LIGHT_SOURCES[
    "CIE 1964 10 Degree Standard Observer"
]

CCS_LIGHT_SOURCES["CIE 1931 2 Degree Standard Observer"].update(
    CCS_LIGHT_SOURCES_NIST_TRADITIONAL_STANDARD_OBSERVER_2_DEGREE_CIE1931
)
CCS_LIGHT_SOURCES["CIE 1964 10 Degree Standard Observer"].update(
    CCS_LIGHT_SOURCES_NIST_TRADITIONAL_STANDARD_OBSERVER_10_DEGREE_CIE1964
)
